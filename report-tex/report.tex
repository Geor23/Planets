...
Introduce your game, explaining what it does. The marking panel will play your game - but other academic members of staff and our external examiner may also view the Development Team report as part of the Departmental examination process. Assume that the reader may not have played the game; or even attended Games Day.
...
Team Introduction
Game Concept
Tools Used  (Just An overview More Details Later)
Novelty Component
Software Manual
Running the Game
Adding New Game Functionality
Software Maintenance During Development
Tools Used  (Technical Content max 10 Pages)
Unity Game Engine
Unity Cluster Renderer
Intel NUC (Next Unit of Computing)
Planetarium Facilities
Music Composers
Project Planning
Initial Goals Planned
 In the beginning, there was nothing
 Initial Implementation
 Networking and Players
 Planetarium and Testing
 Gameplay Revisions
 Innovation, Fun and Planets
 Team Process
 Team Members and Roles
 The Good Times
 And The Bad
 Knowledge Gained Through Collaborative Teamwork
 Given A Second Chance We Would Change…
 Methods Employed To Assist Collaborative Development
 Contributions
 Georgiana Ginghina - Project Manager
 Callum Mann - Lead Programmer
 Tom Michiels
 Thomas Camp
 James O’ Connor
 Eleftherios Christodoulou
 Signed Assessment Page
 ...
 Team name: Static Peak 
 We are a team of 6 Computer Scientists from with a wide skillset, from 3D modelling and graphics to game play or networking enthusiasts. We enjoy collaborating to the fullest and working closely to ensure success. We came together as people who like playing video games and are really excited to get a glimpse into the gaming industry in order to create a unique game, whilst discovering a wide range of technologies we have not had the chance to work with before, to highlight our skills as computer scientists.

 1.2  Game Concept
 Our games concept is that it will allow multiple users, to connect together in the same room and play together or against, in order to complete their given objectives.

 1.3  Tools used (Go in further detail in the technical content section)

 1.3.1  Unity Game Engine

 Starting out the project and while trying to flesh out our ideas we had to choose the game engine that would best suit our project. After researching the various open source game engines available to us we settled with Unity’s game engine as it provided us with the tools we needed to achieve our vision of the game. It is an established Game Engine, used by hundreds of thousand of people. We chose Unity for a number of reasons. First, the engines portability was very important to us since we needed to easily port our game to android as well as windows. Also, prior to our team, other developers had successfully ported their projects to the planetarium, so this further supported the engine’s flexibility and our chances of doing the same(the results were great- Remove). Furthermore, Unity allows specification of texture compression and resolution settings for each platform the game engine supports, and provides support for bump mapping,reflection mapping, parallax mapping, screen space ambient occlusion (SSAO), dynamic shadows using shadow maps, render-to-texture and full-screen post-processing effects. Unity's graphics engine's platform diversity can provide a shader with multiple variants and a declarative fallback specification, allowing Unity to detect the best variant for the current video hardware; and if none are compatible, fall back to an alternative shader that may sacrifice features for performance.(Reference wikipedia)

 1.3.2  Unity Cluster Renderer
 ...
 1.3.3  Intel Next Unit of Computing (NUC)
 ...
 Technical Content (10 pages max)
     ...
     GamePlay design challenges
      ...
      TWIN STICK and orientation on planet
       ...
       Look and feel all created by ourselves to be cartoony.
        ...
        The Faculty of Engineering cooperated with the Music Department of University of Bristol and after presenting our game ideas in front of them, we ended up cooperating with two excellent composers, Edward Brown and Matthew Jones. We proceeded with explaining our games concept to them in order to fully immerse them into our idea and the result was very fruitful. They provided us with some magnificent clips for our needs. Specifically, they composed clips for every different planet. Additionally the Pirate and SuperCorp theme, menu themes as well as as sound effects for our projectiles and resource collection.
        ...
        3.4 Knowledge Gained Through Collaborative Teamwork
        ...
        3.5 Given A Second Chance We Would Change ...
        ...
        3.6 Methods Employed To Assist Collaborative Development 
        ...
        Contributions (1 Page per Member)
        4.10   Georgiana Ginghina - Project Manager 
        ...
        4.20  Callum Mann - Lead Blaze It

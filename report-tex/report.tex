...
\noindent 
  ...
  \SetKwFunction{Fsstu}{sendForecastUpdate}
  \SetKwFunction{Fsrr}{serverReceiveResponse}
  \SetKwFunction{Foru}{observerRecieveForecast}
  \SetKwFunction{Fosr}{obesrverSendResponse}
  \SetKwFunction{Fid}{createIdFromPacket}
  \SetKwFunction{Fsp}{storePacketInDict}
  \SetKwFunction{Fort}{originalTimeFromDict}
  \SetKwFunction{Flat}{getMeanLatency}
  \SetKwFunction{Fulat}{updateMeanLatency}
  \SetKwFunction{Frt}{getActualTime}
  \SetKwFunction{Fwait}{waitUntill}
  \SetKwFunction{Fexe}{executeUpdate}
...
\begin{figure}[!htbp]
  ...
  \begin{minipage}[b]{0.2\textwidth}
        \includegraphics[scale=0.1]{logos/file1.png}
        \caption{Old pirates ship}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.2\textwidth}
        \includegraphics[scale=0.2]{logos/file11.png}
        \caption{New pirate ship}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.2\textwidth}
